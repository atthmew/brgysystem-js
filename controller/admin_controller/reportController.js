...
exports.renderReportUser = async (req, res) => {
	try {
		...
		res.render('admin_pages/report_pages/report_user', {
			title: 'Report User',
			user: user,
		});
	} catch (err) {
...
exports.renderReports = async (req, res) => {
	try {
		...
		res.render('admin_pages/report_pages/view_report', { title: 'Reports Page', reports: reports });
	} catch (err) {
		if (err) {
			console.log(err);
			req.session.message = {
...
exports.doneReportConfirmation = async (req, res) => {
	try {
		...
		res.render('admin_pages/report_pages/doneConfirmation', {
			title: 'Confirmation',
			report: reports,
		});
	} catch (err) {
...
exports.renderMoreInfoReport = async (req, res) => {
	try {
		...
		res.render('admin_pages/report_pages/more_info_report', { title: 'Report Information', report: report });
	} catch (err) {
		if (err) {
			console.log(err);
			req.session.message = {
