...
exports.renderAllUser = async (req, res) => {
	try {
		...
		res.render('admin_pages/dashboard_pages/index', {
			title: 'Dashboard',
			users: users,
...
exports.renderCitizen = async (req, res) => {
	try {
		const users = await User.find();
		res.render('admin_pages/citizen_pages/citizen-record', { title: "Citizens' Records", users: users });
	} catch (err) {
		if (err) {
			console.log(err);
			req.session.message = {
...
exports.moreInfo = async (req, res) => {
	try {
		...
		res.render('admin_pages/citizen_pages/more_info', { title: 'More User Info', user: user });
	} catch (err) {
		if (err) {
			console.log(err);
			req.session.message = {
...
exports.renderGiveCert = async (req, res) => {
	try {
		...
		res.render('admin_pages/citizen_pages/give_cert', {
			title: 'Certificates',
			user: user,
		});
	} catch (err) {
...
exports.barangayCert = async (req, res) => {
	try {
		...
		await CertificateReport.create({
			certReportId: id,
			certReportName: user.name,
			certReportPhone: user.phone,
			certReportAddress: user.address,
			certificateReportType: 'Barangay Certificate',
			img: user.img,
		});
	} catch (err) {
		console.error(err);
...
exports.oath = async (req, res) => {
	try {
		...
		await CertificateReport.create({
			...
			certReportPhone: user.phone,
			certReportAddress: user.address,
			certificateReportType: 'Oath of Undertaking',
			img: user.img,
		});
	} catch (err) {
		console.error(err);
...
exports.jobCert = async (req, res) => {
	try {
		...
		await CertificateReport.create({
			...
			certReportPhone: user.phone,
			certReportAddress: user.address,
			certificateReportType: 'Job Certificate',
			img: user.img,
		});
	} catch (err) {
		console.error(err);
...
exports.certOfIndigency = async (req, res) => {
	try {
		...
		await CertificateReport.create({
			...
			certReportPhone: user.phone,
			certReportAddress: user.address,
			certificateReportType: 'Certificate of Indigency',
			img: user.img,
		});
	} catch (err) {
		console.error(err);
...
exports.barangayClearance = async (req, res) => {
	try {
		...
		await CertificateReport.create({
			...
			certReportPhone: user.phone,
			certReportAddress: user.address,
			certificateReportType: 'Barangay Clearance',
			img: user.img,
		});
	} catch (err) {
		console.error(err);
...
exports.renderProfilePic = async (req, res) => {
	try {
		let id = req.params.id;
		const user = await User.findById(id);
		res.render('admin_pages/citizen_pages/profile-picture', { title: 'Upload/Update Profile', user: user });
	} catch (err) {
		if (err) {
			console.log(err);
			req.session.message = {
